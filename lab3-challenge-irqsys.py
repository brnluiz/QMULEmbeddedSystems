...
Two interrupts:
- buttonColourModeIRQ: checks the if the button for colourMode was pressed
- buttonSpeedIRQ: checks the if the button for speed was pressed
